...
def gen():
    ...
    while cap.isOpened():
        ...
        for (x, y, w, h) in faces:
            ...
            # Predict the label and probability using the SVM model
            ...
            # Set the threshold for identifying unknown faces
            threshold = 0.7

            # Determine if the face is known or unknown based on the threshold
